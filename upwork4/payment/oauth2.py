...
import sys
import urllib
import pycurl, cStringIO # for replace 'urllib.urlopen()'

def curl_request(url, data, json_flag=False):
...
def RefreshToken(client_id, client_secret, refresh_token):
  ...
  response = urllib.urlopen(request_url, urllib.urlencode(params)).read()
  #response = curl_request(request_url, urllib.urlencode(params))
  return json.loads(response)
