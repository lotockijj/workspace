...
public class CalculatorTryIt implements ActionListener{ // work only button "+"; 
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(     src == button0 || src == button1 || src == button2 ||
			...
			if(src == buttonPoint && displayField.getText().indexOf('.') < 0) displayField.setText(displayField.getText() + ".");
			result = numberReader();
		}
		...
		if(     src == buttonDivide || src == buttonEqual || src == buttonMinus ||
				...
				src == buttonPlus || src == buttonSQRT){
			if(function) function2 = true; 
			if(function){
